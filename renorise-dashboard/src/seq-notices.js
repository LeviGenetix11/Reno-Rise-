...
export const SEQ_NOTICES = {
  ...
  person_has_open_sequence: ['error', 'This person already has an open follow-up sequence (on another project or another submission with the same email). They get one sequence at a time; stop or finish that one first.'],
  test_record_not_enrollable: ['error', 'This project is marked as a test record, so it can’t be enrolled unless its email is one of the two allowed test addresses.'],
  not_eligible_on_hold: ['error', 'This lead can’t be enrolled: the project is on hold.'],
